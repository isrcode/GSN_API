...
public class Rotina {
    ...
    @JoinTable(name = "TB_PLANTA_ROTINA", joinColumns = @JoinColumn(name = "cd_rotina", referencedColumnName = "cd_rotina"), inverseJoinColumns = @JoinColumn(name = "cd_planta", referencedColumnName = "cd_planta"))
